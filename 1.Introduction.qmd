...
+========================================+===================================================+===============================+
| [**1. Curation**](2_curation.qmd)        | Importing, cleaning, and structuring grouped data | `tidyverse`                   |
+----------------------------------------+---------------------------------------------------+-------------------------------+
| [**2. Analysis**](3.Analysis.qmd)      | Exploring distributions and grouping effects      | `ggplot2`, `dplyr`            |
|                                        |                                                   |                               |
|                                        | Running classic vs mixed models                   | `lme4`, `lmerTest`            |
|                                        |                                                   |                               |
|                                        | Checking assumptions and model stability          | `performance`                 |
+----------------------------------------+---------------------------------------------------+-------------------------------+
| [**3. Results**](4.Results.qmd)          | Plotting results from mixed models                | `sjPlot`, `ggeffects`         |
|                                        |                                                   |                               |
