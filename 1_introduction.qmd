...
|  |
|----|
| Stage \| Focus \| R packages \| ========================================+===================================================+===============================+ [**1. Curation**](2_curation.qmd) \| Importing, cleaning, and structuring grouped data \| `tidyverse` |
| [**2. Analysis**](3_analysis.qmd) |
| [**3. Results**](4_results.qmd) \| Plotting results from mixed models \| `sjPlot`, `ggeffects` \| \| \| \| Presenting your findings (tables, forest plots) \| `ggplot2`, `gt`, `forestplot` \| |
| [**4. Extension task**](5_extension.qmd) \| Generalised or multilevel structures \| `glmmTMB`, `brms` |
